...
$.widget("water.raindrops", {
    options: {
        ...
        color: '#1a1a1a',   // Water Color
        frequency: 2,       // Raindrops frequency. Higher number means more frequent raindrops.
        ...
        rippleSpeed:  0.3,  // Speed of the ripple effect. Higher number means faster ripples.
